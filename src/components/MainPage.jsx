  ...
  return (
    <div className="page  h-screen">
      <div className="nav text-xl h-[10%] overflow--hidden flex flex-row justify-end items-center ">
        <ul className="nav flex flex-row justify-evenly w-1/6 items-center  p-4 text-white space-x-12">
          <li
            onClick={() => {
              setModal("about");
            }}
            className="hover:border-b-blue-600 transition hover:border-b-2 cursor-pointer"
          >
            About
          ...
          <li className="cursor-pointer">
            <button
              ...
              className="m-2 cursor-pointer py-2 px-4 bg-blue-600 border-black rounded-lg hover:bg-blue-500"
            >
      ...
      <div className="content flex w-full flex-row h-[90%]">
        <div className="img border-r-2 border-gray-600 w-2/5 h-full  text-white flex flex-col items-center justify-around py-10 px-6 space-y-6">
          {/* Brand Section */}
          ...
          <div className="text-sm text-gray-400 text-center space-y-4">
            <blockquote className="italic text-gray-300 border-l-4 border-blue-600 pl-4 text-left">
              "The best platform for secure and fair online voting. It changed
              the way we make decisions!"
            </blockquote>
            <div className="text-right text-gray-500">
              — Alex T., Community Leader
            </div>

            <div>
              <h2 className="text-lg font-semibold text-blue-400 mt-4">
                Why NoxVote?
              </h2>
        ...
        <div className="populate pb-16 w-3/5">
          ...
          {modal == "welcome" ? (
            <div className="welcome flex flex-col justify-center items-center h-full">
              ...
              <button
                ...
                className="bg-blue-600 text-white text-2xl rounded-xl cursor-pointer m-12 py-2 px-4 hover:bg-blue-500"
              >
                Register Now
              </button>
            </div>
